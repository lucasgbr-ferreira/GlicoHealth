...
// REQUISIÇÕES {SPRINT3}
// Variável para armazenar o papel selecionado (Médico ou Administrador)
let selectedRole = "";

function openOffcanvasAndCloseModal() {
    // Fecha o modal
    const modal = new bootstrap.Modal(document.getElementById('exampleModal'));
    modal.hide();

    // Abre o offcanvas
    const offcanvas = new bootstrap.Offcanvas(document.getElementById('offcanvasRequest'));
    offcanvas.show();
}

// Função para processar a solicitação de registro
    ...
    getDatabase()
        .then(database => {
            ...
            const newUser = {
                username,
                password,
                role: selectedRole, // Define o papel como Médico ou Administrador
                name: "",
                email: "",
                phone: "",
                profilePicture: "",
                cpf: "",
                comment, // Salva o comentário junto ao registro
            };
            ...
            saveDatabase(newUser)
                .then(() => {
                    ...
                    alert(`Solicitação enviada com sucesso para ${selectedRole}: ${username}`);
                    ...
                    // Fecha o offcanvas
                    const offcanvas = document.getElementById("offcanvasRequest");
