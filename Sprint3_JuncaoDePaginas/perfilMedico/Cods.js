...
function logado(username) {
    document.getElementById("botaologin").src = "InterfaceUsuário/images/User-logado.png";
...
function logout() {
    ...
    document.getElementById("botaologin").src = "InterfaceUsuário/images/User.png"; 
...
function updateThemeStyles() {
    ...
    if (isDarkMode) {
        // Tema Escuro
        document.getElementById("Logo-GilcoHealth").src = 'InterfaceUsuário/images/Logo-GilcoHealth.png';
